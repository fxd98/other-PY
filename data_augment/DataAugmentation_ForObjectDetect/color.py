...
def color(alpha,beta,img_dir,anno_dir,img_write_dir,anno_write_dir):
    ...
    for img_name in img_names:
        ...
        img_write_path=os.path.join(img_write_dir,img_name[:-4]+'c_'+str(int(alpha*10))+'.jpg')
        #
        anno_path=os.path.join(anno_dir,img_name[:-4]+'.xml')
        anno_write_path = os.path.join(anno_write_dir, img_name[:-4]+'c_'+str(int(alpha*10))+'.xml')
        #
...
beta=10
# img_dir='E:/#FU_XD/teacher_wei/img/new'
# anno_dir='E:/#FU_XD/teacher_wei/img/anno'

img_dir='E:/#FU_XD/teacher_wei/img/DataAugmentation_ForObjectDetect/Rotated/rotated_JPEGImages'
anno_dir='E:/#FU_XD/teacher_wei/img/DataAugmentation_ForObjectDetect/Rotated/rotated_Annotations'

img_write_dir='E:/#FU_XD/teacher_wei/img/DataAugmentation_ForObjectDetect/Color/color_JPEGImages'
anno_write_dir='E:/#FU_XD/teacher_wei/img/DataAugmentation_ForObjectDetect/Color/color_Annotations'
for alpha in alphas:
    print('alpha:',alpha)
